...
const TamilWednesdayGain = () => {

  const [users, setUsers] = useState([]);

  const fetchUser = async () => {
    try {
    const response = await fetch('https://dietbackend.onrender.com/api/tamilweightgain');
...
// console.log(Food)
  ...
  return (
    <>
          <h2 className="text-2xl font-semibold mb-2" style={{textAlign:'center'}}>Wednesday</h2>
...
export default TamilWednesdayGain;
